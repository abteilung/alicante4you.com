...
var GeoCodingEditor = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
    ...
    _inherits(GeoCodingEditor, _PureComponent);

    function GeoCodingEditor() {
        var _ref;

        var _temp, _this, _ret;

        _classCallCheck(this, GeoCodingEditor);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GeoCodingEditor.__proto__ || Object.getPrototypeOf(GeoCodingEditor)).call.apply(_ref, [this].concat(args))), _this), _this.handleData = function (encodedAddress) {
            fetch("https://nominatim.openstreetmap.org/search?format=json&addressdetails=1&accept-language=en&q=" + encodedAddress, requestOptions).then(function (response) {
                return response.json();
            }).then(function (data) {
                return data && data[0] && data[0].lat && data[0].lon ? _this.props.commit([data[0].lat, data[0].lon]) : '';
            });
        ...
        }, _this.pointToFormatedString = function (_ref4) {
    ...
    _createClass(GeoCodingEditor, [{
        ...
        value: function render() {
            ...
            var _ref6 = this.hasValue(value) ? value : value,
            ...
            var zip = options && options.zip ? options.zip : "";
            var city = options && options.city ? options.city : "";
            var address = options && options.address ? options.address : "";
            var fullAddress = encodeURI(address + ',' + zip + ',' + city);
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactUiComponents.IconButton, {
                        ...
                        onClick: function onClick() {
                            return commit(_this2.handleData(fullAddress));
                        }
                        //onClick={() => commit(geodata)}
                        , style: "",
                        hoverStyle: "clean",
                        title: i18nRegistry.translate("Abte.GeoCoding:Main:js.location")
                    })
                )
            );
        }
    ...
    return GeoCodingEditor;
}(_react.PureComponent), _class2.propTypes = {
    id: _propTypes2.default.string,
    value: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number, _propTypes2.default.arrayOf(_propTypes2.default.number)]),
...
exports.default = GeoCodingEditor;
...
var _GeoCodingEditor = __webpack_require__(/*! ./GeoCodingEditor */ "./src/GeoCodingEditor.js");

var _GeoCodingEditor2 = _interopRequireDefault(_GeoCodingEditor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)("Abte.GeoCoding:GeoCodingEditor", {}, function (globalRegistry) {
    var editorsRegistry = globalRegistry.get("inspector").get("editors");
    editorsRegistry.set("Abte.GeoCoding/GeoCodingEditor", {
        component: _GeoCodingEditor2.default
    });
});
